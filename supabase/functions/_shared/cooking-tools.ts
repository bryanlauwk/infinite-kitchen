// Cooking tools definitions shared between edge functions
...
export const cookingTools: CookingToolDef[] = [
  // Heat tools
...
/** Set of valid cooking tool names for fast lookup. */
export const cookingToolNames = new Set(cookingTools.map((t) => t.name));

/** Gemini-compatible function tool definitions. */
export const geminiTools = cookingTools.map((tool) => ({
